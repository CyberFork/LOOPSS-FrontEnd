<template>
  <div class="mining">
    <a-box>
      <div class="info">
        <div class="title">
          <div class="address-wrap">{{$t('hello')}}，<span class="address" :title="user">{{user}}</span></div>
          <div>{{$t('mining.info.title')}}</div>
        </div>
        <div class="slogan">{{$t('mining.info.slogan1')}} {{myInfo.needInviteCount}} {{$t('mining.info.slogan2')}}</div>
      </div>
    </a-box>
    <a-box>
    ...
    <a-box>
      <a-card class="task-info">
        ...
        <div class="content">
          <a-text block class="info-content">{{$t('mining.task.info')}}</a-text>
          <div class="flex-box">
    ...
    <a-box class="your-trusts-container" >
      <div class="title">
        <a-space size="large">
          <a-text strong>{{$t('mining.invited.title')}} ({{yourTrusts.total}})</a-text>
          <a-text gray>{{$t('mining.invited.titleTip')}}: {{yourTrusts.speedCount}}</a-text>
        </a-space>
      </div>
